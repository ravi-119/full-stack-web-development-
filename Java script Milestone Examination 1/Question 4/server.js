...
//     firstMarks = perseInt(firstMarks);
//     secondMarks = perseInt(secondMarks);
//     thirdMarks = perseInt(thirdMarks);
//     fourthMarks = perseInt(fourthMarks);
//     fifthMarks = perseInt(fifthMarks);
